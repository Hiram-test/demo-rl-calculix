...
EXPECTED_ANALYSIS_ARTIFACTS = ("aggregate/primary_results.csv", "aggregate/primary_results.json", "aggregate/pairwise_ratios.csv", "aggregate/pairwise_ratios.json", "aggregate/bootstrap.json", "aggregate/prediction_calibration.csv", "aggregate/prediction_calibration.json", "aggregate/failure_matrix.csv", "aggregate/failure_matrix.json", "aggregate/amortized_cost.json", "aggregate/reference_qualification.json", "aggregate/coverage.json", "aggregate/final_gate.json", "EXECUTION_REPORT.md")  # Mirror the complete current analyzer delivery index exactly, including the explicit denominator-qualification receipt.
