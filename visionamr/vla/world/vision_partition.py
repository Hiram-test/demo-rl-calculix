...
@dataclass(frozen=True)  # Make cached semantic regions immutable.
...
class CachedVisionPartition:  # Assign remeshed elements to one fixed semantic vision output.
    ...
    @classmethod  # Build a deterministic cached perception fixture from exact case features.
    ...
    @classmethod  # Restore cached semantic perception through the class constructor.
